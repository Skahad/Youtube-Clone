            ...
            <div className="relative w-full max-w-md bg-white dark:bg-[#212121] rounded-2xl shadow-2xl overflow-hidden animate-in zoom-in-95 fade-in duration-300">
                ...
                <div className="p-6">
                    ...
                    <div className="relative">
                        <div className="flex items-center gap-2 p-3 bg-gray-50 dark:bg-[#121212] border border-gray-200 dark:border-gray-800 rounded-xl group transition-all focus-within:ring-2 focus-within:ring-blue-500/20">
                ...
                <div className="px-6 py-4 bg-gray-50 dark:bg-[#181818] border-t border-gray-100 dark:border-gray-800 flex items-center gap-3">
